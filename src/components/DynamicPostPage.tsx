  ...
  const generateOgImage = async (): Promise<void> => {
    ...
    try {
      const response = await fetch(
        "http://localhost:3000/generate-og-image",
        {
          method: "POST",
          headers: {
      ...
      <div className="w-full max-w-2xl mx-auto bg-white shadow-lg rounded-lg p-8 space-y-6">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-4">
              <label
                ...
                className="flex-1 px-4 py-2 bg-blue-500 text-white rounded-md cursor-pointer hover:bg-blue-600 transition duration-300 text-center"
              >
          ...
          <button
            ...
            disabled={
              isLoading ||
              (!post.title && !post.content && !uploadedImage && !post.imageUrl)
            }
          ...
          {ogImageUrl && (
            <div className="mt-8 space-y-4">
              ...
              <div className="bg-white border border-gray-200 p-4 rounded-md relative">
                <pre className="text-sm overflow-x-auto whitespace-pre-wrap break-all text-black">
                  {metadata}
                </pre>
                <button
              ...
              <p className="text-sm text-gray-600">
                Copy and paste this metadata into your HTML's{" "}
                <code>&lt;head&gt;</code> section to enable OG image
                functionality.
              </p>
            </div>
          )}
